...
SET DetoursOutputX64Directory=%OutputDir%\C++\Monitor.Client\%OutputX64DirectorPath%
SET DetoursOutputX86Directory=%OutputDir%\C++\Monitor.Client\%OutputX86DirectorPath%
...
echo copy "%DetoursOutputX64Directory%\bin\Monitor.Client.dll" "%ClientCLIOutputDirectory%\bin\Monitor.Client.64.dll"
copy "%DetoursOutputX64Directory%\bin\Monitor.Client.dll" "%ClientCLIOutputDirectory%\bin\Monitor.Client.64.dll"
echo copy "%DetoursOutputX86Directory%\bin\Monitor.Client.dll" "%ClientCLIOutputDirectory%\bin\Monitor.Client.32.dll"
copy "%DetoursOutputX86Directory%\bin\Monitor.Client.dll" "%ClientCLIOutputDirectory%\bin\Monitor.Client.32.dll"