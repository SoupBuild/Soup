...
robocopy %OutDir%\C++\Soup\0.19.3\txTMowfPh1V3rPmbvNBmBW9Z8Jg\bin\ %RunDir%\Soup\ /MIR /NJH /NJS /NDL > NUL
robocopy %OutDir%\msbuild\bin\Soup.Build.Generate\Release\net6.0\ %RunDir%\Soup\Generate\ /MIR /NJH /NJS /NDL > NUL
robocopy C:\Users\mwasp\.soup\out\C#\Soup.Cpp\0.2.2\txTMowfPh1V3rPmbvNBmBW9Z8Jg\bin\ %RunDir%\Soup\Generate\Extensions\Soup.Cpp\0.2.2\ /MIR /NJH /NJS /NDL > NUL
robocopy C:\Users\mwasp\.soup\out\C#\Soup.CSharp\0.5.2\txTMowfPh1V3rPmbvNBmBW9Z8Jg\bin %RunDir%\Soup\Generate\Extensions\Soup.CSharp\0.5.2\ /MIR /NJH /NJS /NDL > NUL
