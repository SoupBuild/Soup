		...
		void Generate_Simple()
		{
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Loading previous operation graph",
					"INFO: Operation graph file does not exist",
					"INFO: No valid previous build graph found",
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"Exists: C:/test/output/.soup/EvaluateGraph.bog",
					"Exists: C:/test/output/.soup/",
					"CreateDirectory: C:/test/output/.soup/",
					"OpenWriteBinary: C:/test/output/.soup/EvaluateGraph.bog",
					"Exists: C:/test/output/.soup/",
					"CreateDirectory: C:/test/output/.soup/",
		...
		void Generate_SingleRuntimeDependency()
		{
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"Exists: C:/test/output/MyPackage/.soup/EvaluateGraph.bog",
					"Exists: C:/test/output/MyPackage/.soup/",
					"CreateDirectory: C:/test/output/MyPackage/.soup/",
					"OpenWriteBinary: C:/test/output/MyPackage/.soup/EvaluateGraph.bog",
					"Exists: C:/test/output/MyPackage/.soup/",
					"CreateDirectory: C:/test/output/MyPackage/.soup/",
