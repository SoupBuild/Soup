...
TestState RunBuildRunnerTests() 
 {
	...
	state += Soup::Test::RunTest(className, "Execute_OneOperation_Incremental_NoOperationGraph", [&testClass]() { testClass->Execute_OneOperation_Incremental_NoOperationGraph(); });
