// <copyright company="Soup" file="ExtendedTextTraceListener.cs">
...
namespace Soup
{
	...
	public class TextWriterExtendedTraceListener : ExtendedTraceListener
	{
		...
		/// <devdoc>
		/// <para>Initializes a new instance of the <see cref='TextWriterExtendedTraceListener'/> class with the 
		...
		/// Initializes a new instance of the <see cref='TextWriterExtendedTraceListener'/> class
		/// </summary>
		public TextWriterExtendedTraceListener(string fileName, string name) : base(name)
		{
			_fileName = fileName;
		}
