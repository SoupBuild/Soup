...
TestState RunCompilerArgumentBuilderTests() 
 {
	...
	state += Soup::Test::RunTest(className, "SingleArgument_LanguageStandard(Soup::Cpp::LanguageStandard::CPP11, \"-std=c++11\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Cpp::Compiler::LanguageStandard::CPP11, "-std=c++11"); });
	state += Soup::Test::RunTest(className, "SingleArgument_LanguageStandard(Soup::Cpp::LanguageStandard::CPP14, \"-std=c++14\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Cpp::Compiler::LanguageStandard::CPP14, "-std=c++14"); });
	state += Soup::Test::RunTest(className, "SingleArgument_LanguageStandard(Soup::Cpp::LanguageStandard::CPP17, \"-std=c++17\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Cpp::Compiler::LanguageStandard::CPP17, "-std=c++17"); });
	...
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::Cpp::OptimizationLevel::Size, \"-Oz\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Cpp::Compiler::OptimizationLevel::Size, "-Oz"); });
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::Cpp::OptimizationLevel::Speed, \"-O3\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Cpp::Compiler::OptimizationLevel::Speed, "-O3"); });
