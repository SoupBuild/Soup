...
TestState RunLinkerArgumentBuilderTests() 
 {
	...
	auto testClass = std::make_shared<Soup::Cpp::Compiler::MSVC::UnitTests::LinkerArgumentBuilderTests>();
	TestState state = { 0, 0 };
	...
	state += Soup::Test::RunTest(className, "StaticLibrary_LibraryPaths", [&testClass]() { testClass->StaticLibrary_LibraryPaths(); });
