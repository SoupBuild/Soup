...
TestState RunCompilerArgumentBuilderTests() 
 {
	...
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::Cpp::OptimizationLevel::Size, \"/Os\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Cpp::Compiler::OptimizationLevel::Size, "/Os"); });
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::Cpp::OptimizationLevel::Speed, \"/Ot\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Cpp::Compiler::OptimizationLevel::Speed, "/Ot"); });
