...
TestState RunCompilerArgumentBuilderTests() 
 {
	...
	state += Soup::Test::RunTest(className, "BuildSharedCompilerArguments_SingleArgument_EnableWarningsAsErrors", [&testClass]() { testClass->BuildSharedCompilerArguments_SingleArgument_EnableWarningsAsErrors(); });
