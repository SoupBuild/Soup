...
TestState RunCompilerArgumentBuilderTests() 
 {
	...
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::OptimizationLevel::Size, \"/Os\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Compiler::OptimizationLevel::Size, "/Os"); });
	state += Soup::Test::RunTest(className, "SingleArgument_OptimizationLevel(Soup::OptimizationLevel::Speed, \"/Ot\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Compiler::OptimizationLevel::Speed, "/Ot"); });
