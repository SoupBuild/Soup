...
TestState RunCompilerArgumentBuilderTests() 
 {
	...
	auto testClass = std::make_shared<Soup::Compiler::MSVC::UnitTests::CompilerArgumentBuilderTests>();
	TestState state = { 0, 0 };
	...
	state += SoupTest::RunTest(className, "SingleArgument_LanguageStandard(Soup::LanguageStandard::CPP11, \"/std:c++11\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Compiler::LanguageStandard::CPP11, "/std:c++11"); });
	state += SoupTest::RunTest(className, "SingleArgument_LanguageStandard(Soup::LanguageStandard::CPP14, \"/std:c++14\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Compiler::LanguageStandard::CPP14, "/std:c++14"); });
	state += SoupTest::RunTest(className, "SingleArgument_LanguageStandard(Soup::LanguageStandard::CPP17, \"/std:c++17\")", [&testClass]() { testClass->SingleArgument_LanguageStandard(Soup::Compiler::LanguageStandard::CPP17, "/std:c++17"); });
	...
	state += SoupTest::RunTest(className, "SingleArgument_OptimizationLevel(Soup::OptimizationLevel::Size, \"/Os\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Compiler::OptimizationLevel::Size, "/Os"); });
	state += SoupTest::RunTest(className, "SingleArgument_OptimizationLevel(Soup::OptimizationLevel::Speed, \"/Ot\")", [&testClass]() { testClass->SingleArgument_OptimizationLevel(Soup::Compiler::OptimizationLevel::Speed, "/Ot"); });
