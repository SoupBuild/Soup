...
namespace Monitor::Linux
{
	...
	public:
		...
		virtual void OnFDOpen(int32_t fd, std::string_view mode, int32_t result) = 0;
		virtual void OnFReopen(std::string_view pathname, std::string_view mode, int32_t result) = 0;
