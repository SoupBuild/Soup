...
namespace Monitor
{
	...
	public:
		...
		// UndocumentedApi
		virtual void OnPrivCopyFileExA(std::string_view existingFileName, std::string_view newFileName, bool result) = 0;
		virtual void OnPrivCopyFileExW(std::wstring_view existingFileName, std::wstring_view newFileName, bool result) = 0;
		...
		virtual void OnCopyFileTransactedW(std::wstring_view existingFileName, std::wstring_view newFileName, bool result) = 0;
		virtual void OnCreateDirectoryExA(std::string_view templateDirectory, std::string_view newDirectory, bool result) = 0;
		...
		virtual void OnDeleteFileTransactedA(std::string_view fileName, bool result) = 0;
		virtual void OnDeleteFileTransactedW(std::wstring_view fileName, bool result) = 0;
		...
		virtual void OnGetFileAttributesTransactedA(std::string_view fileName, uint32_t result) = 0;
		virtual void OnGetFileAttributesTransactedW(std::wstring_view fileName, uint32_t result) = 0;
		virtual void OnGetFileBandwidthReservation(bool result) = 0;
		virtual void OnGetFileInformationByHandleEx(bool result) = 0;
		virtual void OnGetFileSecurityA(std::string_view fileName, bool result) = 0;
		...
		virtual void OnMoveFileA(std::string_view existingFileName, std::string_view newFileName, bool result) = 0;
		virtual void OnMoveFileW(std::wstring_view existingFileName, std::wstring_view newFileName, bool result) = 0;
		virtual void OnMoveFileExA(std::string_view existingFileName, std::string_view newFileName, uint32_t flags, bool result) = 0;
		virtual void OnMoveFileExW(std::wstring_view existingFileName, std::wstring_view newFileName, uint32_t flags, bool result) = 0;
		virtual void OnMoveFileTransactedA(std::string_view existingFileName, std::string_view newFileName, uint32_t flags, bool result) = 0;
		virtual void OnMoveFileTransactedW(std::wstring_view existingFileName, std::wstring_view newFileName, uint32_t flags, bool result) = 0;
		virtual void OnMoveFileWithProgressA(std::string_view existingFileName, std::string_view newFileName, uint32_t flags, bool result) = 0;
		virtual void OnMoveFileWithProgressW(std::wstring_view existingFileName, std::wstring_view newFileName, uint32_t flags, bool result) = 0;
		...
		virtual void OnOpenFile(std::string_view fileName) = 0;
		virtual void OnOpenFileById() = 0;
		virtual void OnReadEncryptedFileRaw(uint32_t result) = 0;
		virtual void OnRemoveDirectoryTransactedA(std::string_view pathName, bool result) = 0;
		virtual void OnRemoveDirectoryTransactedW(std::wstring_view pathName, bool result) = 0;
		...
		virtual void OnSetFileAttributesTransactedA(std::string_view pathName, uint32_t fileAttributes, bool result) = 0;
		virtual void OnSetFileAttributesTransactedW(std::wstring_view pathName, uint32_t fileAttributes, bool result) = 0;
