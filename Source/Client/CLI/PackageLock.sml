...
Closures: {
	Root: {
		"C++": [
			...
			{ Name: "Opal", Version: "0.9.0", Build: "Build0", Tool: "Tool0" }
			{ Name: "reflex", Version: "1.0.2", Build: "Build0", Tool: "Tool0" }
			{ Name: "Soup", Version: "../CLI", Build: "Build0", Tool: "Tool0" }
			{ Name: "Soup.Core", Version: "../Core/", Build: "Build0", Tool: "Tool0" }
		...
		Wren: [
			{ Name: "Soup.Build.Utils", Version: "0.3.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.Cpp", Version: "0.7.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.Cpp.Compiler", Version: "0.6.1", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.Cpp.Compiler.MSVC", Version: "0.6.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.CSharp", Version: "0.9.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.CSharp.Compiler", Version: "0.8.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.CSharp.Compiler.Roslyn", Version: "0.8.0", Build: "Build1", Tool: "Tool0" }
			{ Name: "Soup.Wren", Version: "0.2.0", Build: "Build1", Tool: "Tool0" }
		]
	}
	Build0: {
		Wren: [
