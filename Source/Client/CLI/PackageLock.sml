...
Closures: {
	Root: {
		...
		Wren: [
			{ Name: "Soup.Build.Utils", Version: "0.3.0", Build: "Build2", Tool: "Tool0" }
			{ Name: "Soup.Cpp", Version: "0.7.0", Build: "Build2", Tool: "Tool0" }
			{ Name: "Soup.Cpp.Compiler", Version: "0.6.1", Build: "Build2", Tool: "Tool0" }
			{ Name: "Soup.Cpp.Compiler.MSVC", Version: "0.6.0", Build: "Build2", Tool: "Tool0" }
	...
	Build1: {
		Wren: [
			{ Name: "Soup.Cpp", Version: "0.7.0" }
			{ Name: "Soup.Test.Cpp", Version: "0.6.0" }
		]
	}
	Build2: {
		Wren: [
