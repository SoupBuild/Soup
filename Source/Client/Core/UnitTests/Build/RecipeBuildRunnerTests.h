		...
		void Execute_NoDependencies()
		{
			...
			Assert::AreEqual(
				ValueTable(std::map<std::string, Value>({
					...
					{ "LanguageExtensionPath", Value(std::string("./Extensions/Soup.Cpp/0.2.2/Soup.Cpp.dll")), },
		...
		void Execute_BuildDependency()
		{
			...
			Assert::AreEqual(
				ValueTable(std::map<std::string, Value>({
					...
					{ "LanguageExtensionPath", Value(std::string("./Extensions/Soup.CSharp/0.5.2/Soup.CSharp.dll")), },
