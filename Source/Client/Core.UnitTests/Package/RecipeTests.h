	...
	public:
		...
		void InitializerAll()
		{
			auto uut = Recipe(
				...
				Build::Utilities::RecipeLanguageVersion::CPP20,
			...
			Assert::AreEqual(Build::Utilities::RecipeType::Executable, uut.GetType(), "Verify type is correct.");
			Assert::IsTrue(uut.HasLanguageVersion(), "Verify has language version.");
			Assert::AreEqual(Build::Utilities::RecipeLanguageVersion::CPP20, uut.GetLanguageVersion(), "Verify language version is correct.");
		...
		void OperatorNotEqualType()
		{
			...
			Assert::AreNotEqual(
				Recipe(
					"MyPackage",
					SemanticVersion(1, 2, 3),
					Build::Utilities::RecipeType::StaticLibrary,
					Build::Utilities::RecipeLanguageVersion::CPP17,
					std::vector<PackageReference>({
						PackageReference(Path("../OtherPackage")),
					}),
