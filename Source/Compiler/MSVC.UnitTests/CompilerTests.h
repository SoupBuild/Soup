		...
		void Compile_Module()
		{
			...
			auto expected = Memory::Reference<Build::BuildGraphNode>(
				new Build::BuildGraphNode(
					"File.cpp",
					"bin/mock.cl.exe",
					"/nologo /Zc:__cplusplus /std:c++11 /Od /I\"Includes\" /DDEBUG /X /RTC1 /EHsc /MT /module:reference \"Module.pcm\" /module:export /module:output \"obj/File.ifc\" /bigobj /c File.cpp /Fo\"obj/File.obj\"",
					"Source",
					std::vector<std::string>({
						"Module.pcm",
						"File.cpp",
